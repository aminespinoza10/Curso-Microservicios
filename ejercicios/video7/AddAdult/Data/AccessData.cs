...
public class AccessData
    {
        ...
        public string AddAdult(string topicBody)
        {
            try
            {
                ...
                {
                    string sqlQuery = String.Format("INSERT INTO Adults (Name, Lastname, Birthyear, ImageUrl) VALUES ('{0}', '{1}', {2}, '{3}')", name, lastname, birthyear, imageUrl);
            ...
            return "New adult member has been succesfully added";
        }
    }
}